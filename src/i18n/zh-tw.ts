...
const zhTW: LANG_MESSAGE = {
  ...
  singboxSupportEndingMessage: 'Shinra Dashboard 使用 sing-box 原生 API。',
  dontShowAgain: '不再提示',
  skip: '跳過',
  // 工具頁
  networkQuality: '網路品質',
  ...
  protocolTips:
    'Dashboard 必須與 sing-box API 使用同源位址，請從 Shinra API 服務開啟面板。',
  global: '全域',
  direct: '直連',
  ...
  autoDisconnectIdleUDPTip:
    '啟用後，開啟 Dashboard 時將關閉持續時間超過設定分鐘數的 UDP 連線，這可能對某些無法正常自動斷開的 UDP 連線帶來幫助。',
  ...
  importFromBackendTip:
    '預設檔案為 ./shinra-dashboard-settings.json，匯入前請確認該檔案可存取。',
  importFailed: '匯入失敗，請檢查url {url}',
  autoImportFromUrl: '自動匯入',
  autoImportFromUrlTip:
    '啟用後，每次開啟 Dashboard 時會自動從 URL 匯入設定並計算雜湊；雜湊變化時會重新匯入並重新整理頁面。',
  getting: '獲取中...',
