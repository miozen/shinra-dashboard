...
const zh: LANG_MESSAGE = {
  ...
  protocolTips:
    'Dashboard 必须与 sing-box API 使用同源地址，请从 Shinra API 服务打开面板。',
  global: '全局',
  direct: '直连',
  ...
  autoDisconnectIdleUDPTip:
    '启用后，打开 Dashboard 时将关闭持续时间超过配置分钟数的 UDP 连接，这可能对某些无法正常自动断开的 UDP 连接带来帮助。',
  ...
  importFromBackendTip:
    '默认文件为 ./shinra-dashboard-settings.json，导入前请确认该文件可访问。',
  importFailed: '导入失败，请检查url {url}',
  autoImportFromUrl: '自动导入',
  autoImportFromUrlTip:
    '启用后，每次打开 Dashboard 时会自动从 URL 导入设置并计算哈希；哈希变化时会重新导入并刷新页面。',
  getting: '获取中...',
